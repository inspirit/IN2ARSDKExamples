package
{
    ...
    /**
     * Simple FlashCC Away3D + IN2AR mobile demo
     * You can switch base class to compile for FLASH/AIR(ANE)
     * @author Eugene Zatepyakin
     */

    public final class FlashCCMobileAway3DDemo extends  IN2ARNativeBase
    {
        // tracking data file
        ...
        public var streamFPS:int = 15; // Lets use half the fps of our app fps (30) for performance
        public var downScaleRatio:Number = 1; // To optimize fps, you could use a lower resolution here
        ...
        public var mirror:Boolean = false; // Dont mirror camera output

        public function FlashCCMobileAway3DDemo()
        {	
			//Lets make sure our center is in the top left of our stage.
        ...
        private function initAway3D():void
        {
            ...
            away3dView.width = stage.stageHeight; //We use landscape orientation, so stageWidth and stageHeight are switched
            away3dView.height =  (away3dView.width / viewWidth) * viewHeight; //
        ...
        {
			// move 3d view top top of our screen
            if(cameraBuffer){
